...
import { DEFAULT_HUMAN_CONFIG, FAST_HUMAN_CONFIG, HumanBehavior } from '../../core/human-behavior';
...
describe('Config Presets', () => {
  ...
  test('FAST_HUMAN_CONFIG should have faster settings', () => {
    ...
    expect(FAST_HUMAN_CONFIG.click.preDelay.max).toBeLessThan(
      DEFAULT_HUMAN_CONFIG.click.preDelay.max,
    );
