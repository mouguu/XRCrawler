...
describe('DateUtils', () => {
  describe('parseDate', () => {
    it('should parse relative date string like "1 year"', () => {
      const result = DateUtils.parseDate('1 year');
      expect(typeof result).toBe('string');
      expect(result).toMatch(/^\d{4}-\d{2}-\d{2}$/);
    });

    it('should parse relative date string like "3 months"', () => {
      const result = DateUtils.parseDate('3 months');
      expect(typeof result).toBe('string');
      expect(result).toMatch(/^\d{4}-\d{2}-\d{2}$/);
    });

    it('should return absolute date string as-is', () => {
  ...
  describe('generateDateRanges', () => {
    it('should generate daily date ranges', () => {
    ...
    it('should generate monthly date ranges', () => {
    ...
    it('should generate yearly date ranges', () => {
