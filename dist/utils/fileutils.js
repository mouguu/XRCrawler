...
exports.CACHE_ROOT = exports.DEFAULT_OUTPUT_ROOT = void 0;
exports.sanitizeSegment = sanitizeSegment;
exports.ensureDirExists = ensureDirExists;
exports.ensureBaseStructure = ensureBaseStructure;
...
exports.loadSeenUrls = loadSeenUrls;
exports.saveSeenUrls = saveSeenUrls;
...
async function loadSeenUrls(platform = DEFAULT_PLATFORM, identifier = DEFAULT_IDENTIFIER) {
    ...
    try {
        const data = await fs_1.promises.readFile(cacheFile, 'utf-8');
...
async function saveSeenUrls(platform = DEFAULT_PLATFORM, identifier = DEFAULT_IDENTIFIER, urls) {
    ...
    await ensureDirExists(path.dirname(cacheFile));
    try {
        await fs_1.promises.writeFile(cacheFile, JSON.stringify(Array.from(urls), null, 2), 'utf-8');
